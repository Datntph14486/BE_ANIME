...
public class ExportPDFUtils {
    public ByteArrayInputStream exportPdf(List<ExportPdfDTO> exportPdfDTOS, BigDecimal total, String userName, String orderCode, String dis) {
        // tạo một document
        ...
        try {
            ...
            Paragraph paragraph1 = new Paragraph("CỬA HÀNG BÁN ANIME                      GIẤY ĐẢM BẢO HÀNG CHÍNH HÃNG",
                    new Font(font));
            ...
            Paragraph paragraph2 = new Paragraph("___ ANIME ___                                       uy tín quý hơn vàng", new Font(font));
            ...
            font.setSize(11.5f);
            Paragraph paragraph3 = new Paragraph("DC: Khu Ba Vì - Xã Đồng Thái - Huyện Ba Vì - tỉnh Hà Nội \nSĐT: 0329.989.1028- 0986.344.292", new Font(font));
            ...
            font.setStyle(Font.BOLD);
            Paragraph paragraph4 = new Paragraph("CHUYÊN MUA BÁN MÔ HÌNH  - ANIME CÁC LOẠI", new Font(font));
            ...
            exportPdfDTOS.forEach(exportPdfDTO -> {
                ...
                t.addCell(currencyFormat02.format(exportPdfDTO.getPrice()).toString());
                t.addCell(currencyFormat02.format(exportPdfDTO.getTotal()).toString());
            });
//           // tong
            font.setStyle(Font.BOLD);
            ...
            Paragraph paragraph9 = new Paragraph("Ba vì, ngày:" + new Date().getDate() + " tháng:" + (calendar.get(Calendar.MONTH) + 1 ) + " năm: " + calendar.get(Calendar.YEAR), new Font(font));
            ...
            font.setStyle(Font.NORMAL);
            Paragraph paragraph11 = new Paragraph("Liên", new Font(font));
