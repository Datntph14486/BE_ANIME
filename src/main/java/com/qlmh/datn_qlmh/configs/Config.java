...
public class Config {
    ...
    public static String vnp_ReturnUrl = "http://localhost:3000/infor";
//    Mã website của merchant trên hệ thống của VNPAY
    public static String vnp_TmnCode = "NHP9VHV4";
//   vnp_HashSecret: Chuỗi bí mật sử dụng để kiểm tra toàn vẹn dữ liệu khi hai hệ thống trao đổi thông tin (checksum).
    public static String vnp_HashSecret = "JAQDXFPFGYINIDBOBFFSSAKYKCDIJYZD";
